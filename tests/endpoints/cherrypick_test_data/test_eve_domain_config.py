...
def test_plate_specs_validator_generates_issues_for_wrong_types(client, add_to_dart, plate_specs, error_fields):
...
def test_plate_specs_validator_generates_issues_for_null_values(client, add_to_dart, plate_specs, error_fields):
    response = client.post(
        "/cherrypick-test-data",
        json={"add_to_dart": add_to_dart, "plate_specs": plate_specs},
    )
...
def test_plate_specs_validator_generates_issues_for_extra_values(client):
    response = client.post(
        "/cherrypick-test-data",
