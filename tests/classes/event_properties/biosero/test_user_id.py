...
from lighthouse.constants.fields import FIELD_EVENT_RUN_ID, FIELD_CHERRYTRACK_USER_ID, FIELD_CHERRYTRACK_LIQUID_HANDLER_SERIAL_NUMBER, FIELD_CHERRYTRACK_AUTOMATION_SYSTEM_MANUFACTURER, FIELD_CHERRYTRACK_AUTOMATION_SYSTEM_NAME
...
def test_user_id_value_successful(app, run_id, mocked_responses, cherrytrack_mock_run_info):
    with app.app_context():
        ...
        assert val == expected_response["data"][FIELD_EVENT_USER_ID]
