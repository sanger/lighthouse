...
MLWH_SAMPLE_STOCK_RESOURCE: Dict[str, Any] = {
    ...
    "stock_resource": [
        ...
        },
        {
            ...
            "id_sample_tmp": "8",
            "labware_human_barcode": "pb_8",
            "labware_machine_barcode": "pb_8",
            "labware_coordinate": "A1",
            "last_updated": "2015-11-25 11:35:30",
            "recorded_at": "2015-11-25 11:35:30",
            "created": "2015-11-25 11:35:30",
...
EVENT_WH_DATA: Dict[str, Any] = {
    "subjects": [
        ...
        {"id": 3, "uuid": "3".encode("utf-8"), "friendly_name": "beck-ss1", "subject_type_id": 1},
        {"id": 4, "uuid": "4".encode("utf-8"), "friendly_name": "beck-ss2", "subject_type_id": 1},
    ],
    "roles": [
